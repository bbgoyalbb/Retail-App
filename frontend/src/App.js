      ...
      <div className="flex h-screen overflow-hidden bg-background" data-testid="app-shell">
        ...
        <main id="main-content" className="flex-1 overflow-hidden min-w-0 flex flex-col relative" tabIndex={-1}>
          ...
          <div className="flex-1 flex flex-col overflow-hidden">
            <div ref={contentRef} data-page="in" className="flex-1 overflow-y-auto p-4 pt-[calc(64px+var(--offline-banner-h,0px)+16px)] pb-[calc(64px+80px+env(safe-area-inset-bottom,0px)+16px)] md:p-6 md:pt-[calc(1.5rem+var(--offline-banner-h,0px))] md:pb-6 lg:p-8 lg:pt-[calc(2rem+var(--offline-banner-h,0px))] custom-scrollbar">
